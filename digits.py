...
print(digits.data[1])
print(digits.data[1].size)

m = len(digits.data)
print('m = ', m, ' digits total')
...
print("First digits: ", digits.target[:5])
...
print("training_set length: ", len(training_set_x))
print("cross_validation_set_x length: ", len(cross_validation_set_x))
...
print("Accuracy Score: ", score) # percent correct
